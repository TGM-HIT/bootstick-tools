...
#New-IsoFile "\\filesrv-lehrer\home\mschabel\Downloads\tgm-hit-datasticks" -Path "\\filesrv-lehrer\home\mschabel\Downloads\public_ps1.iso" -Title "Public Powershell"
